...
const main = async () => {
    ...
    const bots = await spherov2_js_1.Scanner.findToys([spherov2_js_1.SpheroMini.advertisement]);
    ...
    for (const bot of bots) {
        ...
        const toy = new spherov2_js_1.SpheroMini.advertisement.class(bot.peripheral);
        await toy.start();
        await toy.wake();
